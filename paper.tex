...
\title{Assessing primitives performance\\ on multi-stage execution}
...
\vspace{-0.1cm}
	\paragraph{Number of lines of code:} We measured the number of lines of code of each implementation.
\vspace{-0.1cm}
